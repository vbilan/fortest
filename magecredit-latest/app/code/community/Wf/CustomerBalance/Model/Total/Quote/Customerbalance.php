...
class Wf_CustomerBalance_Model_Total_Quote_Customerbalance extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    /**
     ...
     * @return Wf_CustomerBalance_Model_Total_Quote_Customerbalance
     */
    public function collect(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        if ($quote->getCustomer()->getId()) {
            if ($quote->getUseCustomerBalance()) {
                ...
                $baseBalance = Mage::getModel('wf_customerbalance/balance')
    ...
    public function fetch(Mage_Sales_Model_Quote_Address $address)
    {
        ...
        if ($address->getCustomerBalanceAmount()) {
            $address->addTotal(array(
                'code' => $this->getCode(),
                'title' => Mage::helper('wf_customerbalance')->__('Store Credit'),
