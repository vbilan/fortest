 ...
 */
class Wf_CustomerBalance_Model_Resource_Balance extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('wf_customerbalance/balance', 'balance_id');
    }

    /**
     * Load customer balance data by specified customer id and website id
     *
     * @param Wf_CustomerBalance_Model_Balance $object
     ...
     * @return Wf_CustomerBalance_Model_Resource_Balance
     */
