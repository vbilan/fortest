 ...
 *
 */
class Wf_CustomerBalance_Block_Adminhtml_Sales_Order_Create_Payment
    extends Mage_Core_Block_Template
{
    ...
    {
        if (!Mage::helper('wf_customerbalance')->isEnabled() || !$this->_getBalanceInstance()) {
            return 0.0;
        }
     ...
     *
     * @return Wf_CustomerBalance_Model_Balance|false
     */
    protected function _getBalanceInstance()
    {
        if (!$this->_balanceInstance) {
            ...
            $this->_balanceInstance = Mage::getModel('wf_customerbalance/balance')
