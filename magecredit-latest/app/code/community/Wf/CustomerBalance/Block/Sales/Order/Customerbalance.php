 ...
 *
 */
class Wf_CustomerBalance_Block_Sales_Order_Customerbalance extends Mage_Core_Block_Template
{
    /**
     ...
     *
     * @return Wf_CustomerBalance_Block_Sales_Order_Customerbalance
     */
